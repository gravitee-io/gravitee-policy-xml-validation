...
public class XmlValidationOAIOperationVisitorTest {
    ...
    public void operationWithJsonRequestBody() throws Exception {
        ...
        final String expectedXsdSchema =
            "<?xml version=\"1.0\" encoding=\"UTF-16\"?><schema xmlns=\"http://www.w3.org/2001/XMLSchema\" elementFormDefault=\"qualified\" targetNamespace=\"" +
            XmlValidationOAIOperationVisitor.XSD_TARGET_NAMESPACE +
            "\" xmlns:ns=\"" +
            XmlValidationOAIOperationVisitor.XSD_TARGET_NAMESPACE +
            "\">\n" +
